/**
 * GET /api/shipstation/carrier-services?carrierCode=xxx
 * Returns the list of services available for a given V1 carrier code.
 */
...
export async function GET(req: NextRequest) {
  ...
  try {
    const services = await client.getCarrierServices(carrierCode)
