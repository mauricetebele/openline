...
// Amazon Seller Central returns list filtered by a carrier tracking number.
const amazonReturnUrl = (tracking: string) =>
  `https://sellercentral.amazon.com/gp/returns/list/v2/ref=xx_myr_dnav_xx?searchBy=CarrierTrackingId&searchString=${encodeURIComponent(tracking)}&marketplaceIds=A1AM78C64UM0Y8%2CA33AVAJ2PDY3EV%2CA2Q3Y263D00KWC%2CA39IBJ37TRP1C6%2CA17E79C6D8DWNP%2CA2EUQ1WTGCTBG2%2CA19VAU5U5O7RUS%2CA1PA6795UKMFR9%2CA1F83G8C2ARO7P%2CATVPDKIKX0DER%2CA2VIGQ35RCS4UG&tabId=viewAll&returnRequestState=viewAll&orderBy=CreatedDateDesc&selectedDateRange=30&pendingActionsFilterBy=null&isOnPendingActionsTab=false`
                ...
                <tr key={r.id} onClick={() => (r.completed ? setDetail(r) : setResume(r))}
                  ...
                  <td className="px-3 py-2 font-mono text-gray-600 dark:text-gray-400 whitespace-nowrap">
                    <span className="inline-flex items-center gap-1.5">
                      ...
                      {r.trackingNumber && (
                        <a
                          href={amazonReturnUrl(r.trackingNumber)}
                          onClick={e => { e.preventDefault(); e.stopPropagation(); window.open(amazonReturnUrl(r.trackingNumber!), 'amazonReturns') }}
